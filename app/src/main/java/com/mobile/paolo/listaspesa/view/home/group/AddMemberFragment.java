...
public class AddMemberFragment extends Fragment
{
    ...
    private void showFeedback(int feedbackCode)
    {
        ...
        {
            case GROUP_ADD_OK:
                snackShowStatus = Snackbar.make(getActivity().findViewById(R.id.activity_home), R.string.add_OK, Snackbar.LENGTH_LONG);
                break;
            case GROUP_ADD_KO_NO_USERS:
                snackShowStatus = Snackbar.make(getActivity().findViewById(R.id.activity_home), R.string.add_KO_no_users, Snackbar.LENGTH_LONG);
                break;
